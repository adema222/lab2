...
public class Controller {
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/image.png", new ImageHandler());
    ...
    static class GetStyleHandler implements HttpHandler {
        public void handle(HttpExchange t) throws IOException {
            File file = new File("template/style.css").getCanonicalFile();
    ...
    private static class ImageHandler implements HttpHandler {
        public void  handle(HttpExchange t) throws IOException {
            File image = new File("image.png").getCanonicalFile();
